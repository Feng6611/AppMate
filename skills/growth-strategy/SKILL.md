...
- 近 30 天下载 **<D30>**（前 30 天 <D30_prev> → 近 30 天 <D30>，环比 <up/down> <pct>%）
- 总评论数 **<N>** / 平均评分 **<X>**
- 主市场 **<country>** 占下载量 <pct>%，已启用本地化: `<locale1>` / `<locale2>` ...
- <补充一个 ASO / 本地化 / 评论主题事实>
...
想展开某个策略，告诉我编号，我可以拆成小计划（资源 / 时间线 / 成功指标）。
```
